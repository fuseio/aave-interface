...
export const networkConfigs: Record<string, BaseNetworkConfig> = {
  [122]: {
    name: 'Fuse',
    privateJsonRPCUrl: 'https://rpc.fuse.io',
    publicJsonRPCUrl: [
      'https://rpc.fuse.io',
      'https://rpc.fuse.network',
      'https://fuse-mainnet.public.blastapi.io',
    ],
    publicJsonRPCWSUrl: 'wss://rpc.fuse.io',
    ...
    baseAssetSymbol: 'FUSE',
    wrappedBaseAssetSymbol: 'WFUSE',
    baseAssetDecimals: 18,
    explorerLink: 'https://explorer.fuse.io',
    ratesHistoryApiUrl,
    networkLogoPath: '/icons/networks/fuse.svg',
  },
  [ChainId.sepolia]: {
